...
module top ;
	...
	wire [1:0] tmpOE__SPI_PULLUP_3_net;
	wire [1:0] tmpIO_1__SPI_PULLUP_3_net;
	wire [0:0] tmpINTERRUPT_0__SPI_PULLUP_3_net;
	electrical [0:0] tmpSIOVREF__SPI_PULLUP_3_net;

	cy_psoc3_pins_v1_10
		#(.id("dde42c50-4720-4d66-a84c-2e57ccb87339"),
		...
		SPI_PULLUP_3
		 (.oe(tmpOE__SPI_PULLUP_3_net),
		  .y({2'b0}),
		  .fb({Net_136, Net_135}),
		  .io({tmpIO_1__SPI_PULLUP_3_net[1:0]}),
		  .siovref(tmpSIOVREF__SPI_PULLUP_3_net),
		  .interrupt({tmpINTERRUPT_0__SPI_PULLUP_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SPI_PULLUP_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{2'b11} : {2'b11};

	wire [1:0] tmpOE__SPI_PULLUP_2_net;
	wire [1:0] tmpIO_1__SPI_PULLUP_2_net;
	wire [0:0] tmpINTERRUPT_0__SPI_PULLUP_2_net;
	electrical [0:0] tmpSIOVREF__SPI_PULLUP_2_net;

	cy_psoc3_pins_v1_10
		#(.id("0d36c66d-7e78-46eb-a10c-56ec891c2609"),
		  .drive_mode(6'b010_010),
		  .ibuf_enabled(2'b1_1),
		  .init_dr_st(2'b1_1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(4'b00_00))
		SPI_PULLUP_2
		 (.oe(tmpOE__SPI_PULLUP_2_net),
		  .y({2'b0}),
		  .fb({Net_134, Net_133}),
		  .io({tmpIO_1__SPI_PULLUP_2_net[1:0]}),
		  .siovref(tmpSIOVREF__SPI_PULLUP_2_net),
		  .interrupt({tmpINTERRUPT_0__SPI_PULLUP_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SPI_PULLUP_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{2'b11} : {2'b11};

	wire [1:0] tmpOE__SPI_PULLUP_1_net;
	wire [1:0] tmpIO_1__SPI_PULLUP_1_net;
	wire [0:0] tmpINTERRUPT_0__SPI_PULLUP_1_net;
	electrical [0:0] tmpSIOVREF__SPI_PULLUP_1_net;

	cy_psoc3_pins_v1_10
		#(.id("a4d9df60-9c72-4d22-8fff-f91a060c69cc"),
		  .drive_mode(6'b010_010),
		  .ibuf_enabled(2'b1_1),
		  .init_dr_st(2'b1_1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(4'b00_00))
		SPI_PULLUP_1
		 (.oe(tmpOE__SPI_PULLUP_1_net),
		  .y({2'b0}),
		  .fb({Net_132, Net_131}),
		  .io({tmpIO_1__SPI_PULLUP_1_net[1:0]}),
		  .siovref(tmpSIOVREF__SPI_PULLUP_1_net),
		  .interrupt({tmpINTERRUPT_0__SPI_PULLUP_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SPI_PULLUP_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{2'b11} : {2'b11};
	...
	cy_psoc3_pins_v1_10
		#(.id("6cad43ad-8649-4efd-b03a-7541fa7faf6f"),
		  .drive_mode(6'b010_010),
		  .ibuf_enabled(2'b1_1),
		  .init_dr_st(2'b1_1),
		  .input_clk_en(0),
